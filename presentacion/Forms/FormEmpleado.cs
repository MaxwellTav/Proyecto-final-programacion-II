...
namespace presentacion.Forms
{
    public partial class FormEmpleado : Form
    {
        ...
        private void btnDesactivar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Para desabilitar el usuario necesita seleccionar una fila", "¿Algo no cuadra?", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btncrear_Click(object sender, EventArgs e)
        {
            if (txtCedula.Text != "" && txtNombre.Text != "" && txtApellido.Text != "")
            {
              ...
              //  MessageBox.Show(cedula.Length.ToString());
                ...
                {
                    MessageBox.Show("Este Empleado ya existe en el sistema", "Algo falla!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
            {
                MessageBox.Show("Algunas de las campos esta vacio", "Faltan credenciales", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Para Editar | Modificar necesita seleccionar una fila", "mmm ¿Algo falta?", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void txtCedula_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                MessageBox.Show("Solo se permiten numeros aqui","Error de caracter", MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
                e.Handled = true;
