...
namespace presentacion.Forms
{
    public partial class FormUsuario : Form
    {
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Para Editar | Modificar necesita seleccionar una fila", "Error leve", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Para Desactivar el usuario necesita seleccionar una fila", "Error leve", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if ( txtPass.Text != "" && txtUsername.Text != "")
            {
                ...
                {
                    MessageBox.Show("Este usuario ya existe", "Credenciales repetidas!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }

            }
            else
            {
                MessageBox.Show("Algunas de las campos esta vacio", "Error leve", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
