...
namespace presentacion.Forms
{
    public partial class FormRegistro_entrada : Form
    {
            ...
            if (ultimaFecha.Rows.Count != 0)
            {
                if (Datos.Rows.Count != 0)
                {
                    ...
                    if (datosEmpleados.Length != 0)
                    {
                        ...
                        if (f == ff && fff == "" )
                        {
                            MessageBox.Show("Este Empleado empezado su horario laborar", "Notificación!", MessageBoxButtons.OK, MessageBoxIcon.Question);
                            btnRegistrarSalida.Enabled = true;
                        }
                        else if (fff != "")
                        {
                            MessageBox.Show("Este Empleado acabo con su horario laborar", "Notificación", MessageBoxButtons.OK, MessageBoxIcon.Question);
                        }
                        else
                        {
        ...
        private void btnRegistrarEntrada_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No a Seleccionado a un empleado", "Error leve!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void btnRegistrarSalida_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No a Seleccionado a un empleado", "Error leve", MessageBoxButtons.OK, MessageBoxIcon.Question);
            }
